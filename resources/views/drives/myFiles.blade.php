    ...
    <div class="container">
        <div class="card mt-4">
            ...
            <div class="card-header">
                <h5 class="card-title">List My Files</h5>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @forelse ($drives as $drive)
                            <tr>
                                ...
                                <td>{{ $drive->file }}</td>
                                @php
                                    $lockIcon = ($drive->status === 'private') ? '<i class="text-info fas fa-lock" title="make it public"></i></a>' : '<i class="text-warning fa-solid fa-lock-open" title="make it private"></i>';
                                @endphp
                                <td><a href="{{ route("drives.changeStatus",$drive->id) }}">{!! $lockIcon !!}</a></td>
